...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-20 10:12`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ca457fe0-70d8-497c-a7ec-4b2a68b8e338.git
$ cd ca457fe0-70d8-497c-a7ec-4b2a68b8e338
```
